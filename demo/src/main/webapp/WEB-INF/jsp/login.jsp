		...
		<div id="wrapper" class="container">
			...
			<section class="main-content">				
				<div class="row">
					...
					<div class="span7">		
						<c:url var="log_action" value="/users/loginUser"/>			
						<form action="${log_action}" method="post" class="form-stacked" modelAttribute="loginUser">
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<p class="reset"> <a tabindex="4" href="/users/register" >Register now</a></p>
								</div>
							</fieldset>
						</form>					
					</div>				
