...
("System_admin", "nadjazorboski@gmail.com", "Novosadskog sajma 5, Novi Sad", "Nadja" , "nadjazorboski", "5655", 1, "Zorboski", 0); 

insert into configurationexample.user (type, email, address, name, password, phone, role, surname, activate) values
("Visitor", "jocaftn15@gmail.com", "Novosadskog sajma 5, Novi Sad", "Jovana" , "jovanajovanovic", "5655", 0, "Jovanovic", 1); 
insert into configurationexample.user (type, email, address, name, password, phone, role, surname, activate) values
("Visitor", "jovanaftn@yahoo.com", "Novosadskog sajma 5, Novi Sad", "Jovana" , "jovanajovanovic", "5655", 0, "Jovanovic", 1); 
